...
```bash
cat ~/.google_workspace_mcp/credentials/google-workspace-user.json
```

The token file lives at `~/.google_workspace_mcp/credentials/google-workspace-user.json`.
...
token_path = Path('~/.google_workspace_mcp/credentials/google-workspace-user.json')
...
**Note:** Credentials are stored in `~/.google_workspace_mcp/credentials/`, NOT in `~/.hermes/`.
