...
## Storage Convention
All data under ~/openclaw/data/ocas-{skill}/ and journals under ~/openclaw/journals/ocas-{skill}/. OCAS_ROOT env var overrides ~/openclaw. No data inside skill packages.
